        ...
        <div className="info">
            <div className="container">
                <div className="info__box">
                    ...
                    <p data-aos="fade-up" className="info__txt">Odilxon Kamolov O‘zbekiston MMA sportining yorqin yulduzlaridan biri bo‘lib, hozirda <span>OctagonLeague</span> doirasida faoliyat olib boradi. U jang san’atidagi yuqori mahorati va janglarda qo‘lga kiritgan yutuqlari bilan tanilgan. Kamolovning jang uslubi kuchli zarbalari, aniqligi va parterdagi ustunligi bilan ajralib turadi, bu esa uni qit’a miqyosida taniqli jangchiga aylantirgan. Bundan tashqari, Odilxon Kamolov nafaqat sport sohasida, balki ta’lim yo‘nalishida ham muvaffaqiyatga intilmoqda. U hozirda <span>Alfraganus</span> universitetining 3-kurs talabasi bo‘lib, bilim va sportni birdek rivojlantirishga e’tibor qaratmoqda.</p>
